    ...
    [
        *(
            _entry(
                ...
                availability="deprecated", regions=("global",),
                capabilities=_capabilities(streaming=True),
                source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/deprecations/open-models",),
                support_evidence="offline-contract", verified_at="2026-09-19",
            )
            for model_id in (
        ...
        _entry(
            "vertex", "openai/gpt-oss-120b-maas", aliases=("gpt-oss-120b-maas",),
            availability="stable", regions=("global",),
            recommended_for=("chat", "tools"),
            capabilities=_capabilities(streaming=True, tools=True, structured_output=True, json_mode=True, tool_choice=True),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/maas/openai/gpt-oss-120b",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "zai-org/glm-5.2-maas", aliases=("glm-5.2-maas",),
            availability="preview", regions=("global",),
            recommended_for=("chat", "tools"), capabilities=_capabilities(streaming=True, tools=True, structured_output=True, json_mode=True, tool_choice=True),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/maas/zaiorg/glm-52",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "veo-3.1-generate-001", api_surface="video",
            availability="stable", regions=("us-central1",),
            recommended_for=("vision",), capabilities=_VIDEO,
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/veo/3-1-generate",),
            verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "veo-3.1-fast-generate-001", api_surface="video",
            availability="stable", regions=("us-central1",),
            recommended_for=("vision",), capabilities=_VIDEO,
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/veo/3-1-generate",),
            verified_at="2026-09-19",
        ...
        _entry(
            "vertex", "veo-3.1-lite-generate-001", api_surface="video",
            availability="preview", regions=("us-central1",),
            recommended_for=("vision",), capabilities=_VIDEO,
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/veo/3-1-generate",),
            verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "gemini-3.1-flash-lite-image", api_surface="image",
            availability="stable", regions=("global",),
            recommended_for=("vision",), capabilities=_IMAGE,
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-versions",),
            verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "gemini-2.5-flash-image", api_surface="image",
            availability="stable", regions=("global",),
            recommended_for=("vision",), capabilities=_IMAGE,
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-versions",),
            verified_at="2026-09-19",
        ...
        _entry(
            "vertex", "gemini-2.5-flash-tts", api_surface="speech",
            availability="stable", regions=("global",),
            recommended_for=("audio",), capabilities=_SPEECH,
            source_urls=("https://docs.cloud.google.com/text-to-speech/docs/gemini-tts",),
            verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "gemini-2.5-pro-tts", api_surface="speech",
            availability="stable", regions=("global",),
            recommended_for=("audio",), capabilities=_SPEECH,
            source_urls=("https://docs.cloud.google.com/text-to-speech/docs/gemini-tts",),
            verified_at="2026-09-19",
        ...
        _entry(
            "vertex", "gemini-2.5-flash-lite-preview-tts", api_surface="speech",
            availability="preview", regions=("global",),
            recommended_for=("audio",), capabilities=_SPEECH,
            source_urls=("https://docs.cloud.google.com/text-to-speech/docs/gemini-tts",),
            verified_at="2026-09-19",
        ...
        _entry(
            ...
            api_surface="realtime", recommended_for=("audio", "realtime"),
            capabilities=_REALTIME,
            regions=("us-central1", "us-east1", "us-east4", "us-east5", "us-south1",
                     "us-west1", "us-west4", "europe-central2", "europe-north1",
                     "europe-southwest1", "europe-west1", "europe-west4", "europe-west8"),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/2-5-flash-live-api",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "gemini-embedding-2", api_surface="embedding",
            recommended_for=("embedding", "retrieval"), capabilities=_EMBEDDING,
            regions=("us",),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/embeddings/get-multimodal-embeddings",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "google/gemma-4-26b-a4b-it-maas",
            aliases=("gemma-4-26b-a4b-it-maas",),
            availability="preview", regions=("global",),
            recommended_for=("chat", "vision", "tools"),
            capabilities=_capabilities(streaming=True, tools=True, structured_output=True,
                json_mode=True, tool_choice=True, vision=True),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/maas/google/gemma-4-26b-a4b-it",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        _entry(
        ...
        _entry(
            "vertex", "gemini-3.8-flash-cyber",
            recommended_for=("chat", "reasoning", "vision"),
            capabilities=_capabilities(streaming=True, structured_output=True, json_mode=True, vision=True, files=True, audio_input=True, reasoning=True),
            availability="limited", regions=("global", "us"),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-8-flash-cyber",),
            support_evidence="offline-contract", verified_at="2026-09-19",
        ),
        ModelCatalogEntry(
            provider="vertex", model_id="gemini-robotics-er-2-preview",
            availability="preview", regions=("global",),
            capabilities=_capabilities(vision=True, files=True, reasoning=True),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/gemini-robotics-er", "https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/gemini-robotics-er/spatial"),
            support_evidence="catalog-only", verified_at="2026-09-19",
        ),
        _entry(
            "qwen",
            "qwen3.8-max-0902",
        ...
        # Vertex entries use host-specific IDs and evidence, independently of Gemini.
        _entry(
            "vertex", "gemini-3.5-live-translate-preview",
            api_surface="realtime", availability="preview",
            recommended_for=("audio",), regions=("global",),
            verified_at="2026-09-19", support_evidence="offline-contract",
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-5-live-translate",),
            capabilities=_capabilities(audio_input=True, audio_output=True, realtime=True, realtime_audio_input=True, realtime_audio_output=True),
        ),
        _entry(
            "vertex", "gemini-omni-1.1-flash-preview",
            api_surface="interactions", availability="preview",
            recommended_for=("vision",), regions=("global",),
            verified_at="2026-09-19",
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/omni-1-1-flash",),
            capabilities=_capabilities(vision=True, files=True, reasoning=True),
        ),
        _entry(
            "vertex", "gemini-3.5-transcribe-live-preview",
            api_surface="realtime", availability="preview",
            recommended_for=("audio",), regions=("global",),
            verified_at="2026-09-19", support_evidence="offline-contract",
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-5-transcribe",),
            capabilities=_capabilities(audio_input=True, realtime=True, realtime_audio_input=True),
        ),
        _entry(
            "vertex", "gemini-3.5-transcribe-preview",
            api_surface="transcription", availability="preview",
            recommended_for=("audio",), regions=("global",),
            verified_at="2026-09-19", support_evidence="offline-contract",
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-5-transcribe",),
            capabilities=_TRANSCRIPTION,
        ...
        _entry(
            ...
            availability="preview",
            regions=("global",),
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-1-pro",),
            capabilities=_GEMINI_LANGUAGE,
            verified_at="2026-09-19",
        ),
        _entry(
            "vertex", "mistralai/mistral-medium-3", aliases=("mistral-medium-3",),
            regions=("us-central1", "europe-west4"), recommended_for=("chat", "tools", "vision"),
            capabilities=_capabilities(streaming=True, tools=True, tool_choice=True, vision=True), support_evidence="offline-contract",
            source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/partner-models/mistral/mistral-medium-3",),
            verified_at="2026-09-19",
        ),
        *(
            _entry(
                "vertex", f"mistralai/{model}", aliases=(model,),
                regions=("us-central1", "europe-west4"), recommended_for=("chat",),
                capabilities=_capabilities(streaming=True, vision=model == "mistral-small-2503"),
                support_evidence="offline-contract",
                source_urls=("https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/partner-models/mistral",),
                verified_at="2026-09-19",
            )
            for model in ("mistral-small-2503", "codestral-2")
        ),
        _entry(
            "vertex",
            "gemini-3.1-pro-preview",
