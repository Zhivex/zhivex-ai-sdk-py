...
default_model_catalog = create_model_catalog(
    [
        ...
        ModelCatalogEntry("openai", "gpt-realtime-2", aliases=["gpt-realtime-1.5", "gpt-realtime"], recommended_for=["speed", "audio"]),
        ...
        ModelCatalogEntry("azure-openai", "gpt-realtime-2", aliases=["gpt-realtime-1.5", "gpt-realtime"], recommended_for=["speed", "audio"]),
        ...
        ModelCatalogEntry("gemini", "imagen-4.0-generate-001", recommended_for=["vision"]),
        ModelCatalogEntry("gemini", "veo-3.1-generate-preview", recommended_for=["vision"]),
        ModelCatalogEntry("gemini", "veo-3.1-lite-generate-preview", recommended_for=["speed", "vision"]),
        ...
        ModelCatalogEntry("vertex", "imagen-4.0-generate-001", recommended_for=["vision"]),
        ModelCatalogEntry("vertex", "veo-3.1-generate-preview", recommended_for=["vision"]),
        ModelCatalogEntry("vertex", "veo-3.1-lite-generate-preview", recommended_for=["speed", "vision"]),
