...
_WORKFLOW_STABLE_EXPORTS = frozenset(
    (
        "WORKFLOW_ADAPTER_SCHEMA_VERSION",
        "WORKFLOW_CHECKPOINT_SCHEMA_VERSION",
        "CallbackWorkflowAdapter",
...
# Stable workflow annotations expose JsonValue directly, so it is part of the
# same compatibility cohort rather than a Beta implementation detail.
...
_NOTES_BY_EXPORT = {
    ...
    "create_dbos_workflow_adapter": "beta named-engine factory; not a certified DBOS integration",
    "create_prefect_workflow_adapter": "beta named-engine factory; not a certified Prefect integration",
    "create_restate_workflow_adapter": "beta named-engine factory; not a certified Restate integration",
