...
_MODULE_EXPORTS = {
    ...
    "catalog": ("CatalogProviderId", "ModelApiSurface", "ModelAvailability", "ModelSupportEvidence", "RecommendedUse", "ModelPricing", "ModelCatalog", "ModelCatalogEntry", "create_model_catalog", "default_model_catalog"),
