...
- Model catalog helpers. Entries, aliases, lifecycle, sources, capabilities, and typed pricing remain Beta metadata. Construction rejects identifier collisions, catalog reads are defensive, recommendations do not imply capabilities, and the default snapshot does not constitute live certification or automatic provider discovery.
