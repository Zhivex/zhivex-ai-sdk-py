...
- Native `qwen3.8-omni-flash` mixed image/audio/video input through Responses,
  ...
  model-specific capability/catalog records. Reasoning budgets use Chat Completions;
  thinking with web search transparently collects the provider-required stream.
- Deterministic multimodal contracts, synthetic fixtures, and source/installed-wheel live smoke runners.
